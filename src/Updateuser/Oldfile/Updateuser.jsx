...
const UpdateWallet = ({Display}) => {
  ...
  // const [sessionTime, setSessionTime] = useState()
    ...
    const url = `https://chi-backend-omega.vercel.app/api/alluserdata`
  ...
  useEffect(()=>{
      ...
      const deleteprofile = (id) => {
        const url = `https://chi-backend-omega.vercel.app/api/userdata/${id}`
        axios.delete(url)
        .then(res => {
          console.log(res)
          window.location.reload()
      ...
      const updateprofile = (id) => {
        const updateuserurl = `https://chi-backend-omega.vercel.app/api/userdata/${id}`
